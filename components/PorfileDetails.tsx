        ...
        <div className="relative flex-shrink-0 mb-4 md:mb-0 w-full md:w-auto text-center md:text-left">
          {discord ? (
            ...
            <div className="w-24 h-24 md:w-36 md:h-36 mx-auto md:mx-0 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
              <Image className="rounded-full hover:opacity-75 transition duration-700" src="https://share.creavite.co/67af43c7b4fa2d2289ea7521.gif" alt="avatar" width={1024} height={1024} />
            </div>
          )}
        </div>
        <div className="flex flex-col items-center md:items-start md:w-8/12 md:ml-6 text-center md:text-left">
          <div className="space-y-2">
            ...
            <p className="text-center md:text-left" style={{ fontSize: '0.8rem', paddingTop: '1rem' }}>
             I have been learning software myself for 3+ years and sharing the software I have been doing for 3 years on GitHub. I&apos;ve been writing Hacking Tools for a long time, but now I&apos;m focused on web development.
            </p>
          </div>
        </div>
      </div>
              ...
              <ActivityCard
                ...
                imageUrl={
                  activity.assets && activity.assets.large_image
                    ...
                    : 'https://cdn.discordapp.com/attachments/1339951984987471978/1340611438032715806/standard_2.gif'
                }
                name={activity.name}
